...
export interface AgentSessionConfig {
	...
	/**
	 * Root directory the built-in file tools may access (see CreateAgentSessionOptions.allowedRoot).
	 * Used by `_buildRuntime` when constructing default tool definitions. Ignored
	 * when `baseToolsOverride` is set (caller controls the tools directly).
	 */
	allowedRoot?: string;

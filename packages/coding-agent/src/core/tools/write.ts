...
import { resolveToCwdStrict } from "./path-utils.js";
...
export interface WriteToolOptions {
	...
	/**
	 * Root directory the write tool is allowed to access (absolute paths or `..`
	 * escapes up to this boundary are permitted). Defaults to `cwd`.
	 */
	allowedRoot?: string;
}
...
export function createWriteToolDefinition(
	...
	return {
		...
		async execute(
			...
			const absolutePath = resolveToCwdStrict(path, cwd, allowedRoot);

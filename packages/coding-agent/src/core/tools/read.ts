...
export interface ReadToolOptions {
	...
	/**
	 * Root directory the read tool is allowed to access (absolute paths or `..`
	 * escapes up to this boundary are permitted). Defaults to `cwd`. Set broader
...
export function createReadToolDefinition(
	...
	return {
		...
		async execute(
			...
			const absolutePath = resolveReadPath(path, cwd, allowedRoot);
